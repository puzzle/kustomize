...
func (ut *diamonImportTest) writeKustCommon(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeKustComponent2(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeKustComponent1(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeKustMyApp(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeCommonConfigMap(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeComponent2(th kusttest_test.Harness) {
...
func (ut *diamonImportTest) writeComponent1(th kusttest_test.Harness) {
...
func TestSimpleDiamondImport(t *testing.T) {
	...
	m := th.Run("/diamondimport/myapp", th.MakeDefaultOptions())
	th.AssertActualEqualsExpected(m, `
apiVersion: v1
data:
  settings: |
