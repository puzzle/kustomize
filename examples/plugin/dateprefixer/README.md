# Test CRD Register dateprefixer


This folder demonstrates how to use dateprefixer Kustomize Transformer
...
kind: Namespace
metadata:
  name: 2018-05-11-thenamespace
---
apiVersion: apiextensions.k8s.io/v1beta1
kind: CustomResourceDefinition
metadata:
  name: 2018-05-11-mycrds.my.org
spec:
