# Test CRD Register patchjson6902transformer


This folder demonstrates how to use patchjson6902transformer Kustomize Transformer
...
### Preparation Step JSON Patch

<!-- @createOther0 @test -->
```bash
cat <<'EOF' >${DEMO_HOME}/patch.json
